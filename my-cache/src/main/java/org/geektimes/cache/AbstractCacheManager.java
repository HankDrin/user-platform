...
public abstract class AbstractCacheManager implements CacheManager {
    ...
    protected <K, V, C extends Configuration> Cache<K, V> getOrCreateCache(String cacheName, C configuration, boolean created) {
        assertNotClosed();

        Map<KeyValueTypePair, Cache> cacheMap = cacheRepository.computeIfAbsent(cacheName,
